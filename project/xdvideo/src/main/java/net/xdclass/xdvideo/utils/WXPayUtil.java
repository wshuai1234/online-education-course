...
/**
 * wechat pay util class, xml to map, map to xml, generate signature
 */
public class WXPayUtil {
     ...
     * @return XML data tranformed Map
     * @throws Exception
     */
    ...
    public static String createSign(SortedMap<String, String> params, String key){
        ...
        //generate stringA="appid=wxd930ea5d5a258f4f&body=test&device_info=1000&mch_id=10000100&nonce_str=ibuaiVcKdpRxkhJA";
        while (it.hasNext()){
